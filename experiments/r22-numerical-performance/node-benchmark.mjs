...
async function loadProductionModules() {
  ...
  try {
    ...
    return {
      ...
      getDamageStatistics: damageStatistics.getDamageStatistics,
      ...
      getScoreStatistics: scoreStatistics.getScoreStatistics,
      getTotalDamageStatistics: damageStatistics.getTotalDamageStatistics,

...
The stress variants use the fixed ordinary and Living Dead fixtures generated by `find-backtrack-label-stress.mjs`. The adaptive 9px variant adds scriptable radial label placement only inside the experiment response patch; no Chart.js option is changed in production.

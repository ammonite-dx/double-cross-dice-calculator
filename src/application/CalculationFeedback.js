...
const RANGE_REASON_BY_CODE = Object.freeze({
  ...
  'attack-display-recalculate': 'Attackのcanonical計算結果に指定表示範囲のcoverageがないため、表示できません。',
  'attack-display-resource-rejected': 'Attackのcanonical表示範囲が資源上限を超えているため、表示できません。',
  'attack-display-not-projectable': 'Attackのcanonical計算結果を指定の表示範囲へ安全に投影できません。',
  'attack-score-display-recalculate': 'Attackのcanonical Scoreに指定表示範囲のcoverageがないため、表示できません。表示範囲を狭めて再入力してください。',
  'attack-score-display-resource-rejected': 'Attackのcanonical Score表示範囲が資源上限を超えているため、表示できません。表示範囲を狭めて再入力してください。',
  'attack-score-display-not-projectable': 'Attackのcanonical Score計算結果を指定の表示範囲へ安全に投影できません。表示範囲を狭めて再入力してください。',
  'attack-summary-not-projectable': 'canonicalの期待値が正確値でないため、サマリーの数値を表示できません。',

<script setup>
    ...
    import { getAttackScoreChartData,getAttackScoreChartOptions,getAttackScoreChartStyle } from './ChartSetter';
    ...
    const data = computed(() => getAttackScoreChartData(props.attackData,props.setting));

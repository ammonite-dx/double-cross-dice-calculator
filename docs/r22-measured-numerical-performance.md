...
R22の開始点は、R21の最終commit `cb79c9c39f878094c77ca10699bd6a25a9bbb530`である。測定結果を記録するまでは、production source、test、UI、公開asset、generator、reference-data、Worker境界、resource policyを変更しない。
...
R22-Aの測定ハーネスとbaseline結果は未着手である。productionの計算意味論、UI、Worker構成、公開schema、reference-dataはR22-Aの完了まで変更しない。

...
R25-M以降の詳細な実装・検証記録は、作業単位ごとのarchiveに分けています。

- R25-M: [reaction score resolution separation](./r25-m-reaction-score-resolution-separation.md)
- R26-A〜D: [result contracts](./r26-a-result-contracts-calculation-semantic-boundaries.md)、[execution decomposition](./r26-b-calculation-execution-decomposition.md)、[shihai order-statistic](./r26-c-shihai-order-statistic-simplification.md)、[exact-tail closure](./r26-d-shihai-exact-tail-closure.md)
- R27-A〜B: [advanced settings](./r27-a-advanced-settings-semantic-boundary.md)、[feature boundaries](./r27-b1-typed-client-feature-boundaries.md)、[request coordination](./r27-b2a-typed-request-coordination.md)、[CalculationClient](./r27-b2b-typed-calculation-client.md)、[ResourceGuard](./r27-b2c1-typed-resource-guard.md)、[Damage Roll client](./r27-b2c2-typed-runtime-damage-roll-client.md)、[Check range policy](./r27-b2c3-typed-check-range-policy.md)
- R28-A〜F: [repository cleanup](./r28-a-mechanical-repository-cleanup.md)、[architecture enforcement](./r28-b1-architecture-enforcement-cleanup.md)、[experiment isolation](./r28-b2-historical-test-isolation.md)、[UI structure](./r28-c-thin-ui-structure-cleanup.md)、[display styles](./r28-d-display-style-ownership.md)、[feedback presentation](./r28-e1-feedback-presentation-separation.md)、[Backtrack presentation](./r28-e2-backtrack-chart-presentation-cleanup.md)、[repository closure](./r28-f-repository-cleanup-closure.md)
- R29-A〜I: [FFT consolidation](./r29-a-fft-primitive-consolidation.md)、[Damage aggregation](./r29-b-damage-aggregation-preparation.md)、[presentation trust boundary](./r29-c-presentation-trust-boundary.md)、[Attack lifecycle](./r29-d-attack-lifecycle-convergence.md)、[compatibility surface](./r29-e-compatibility-surface-cleanup.md)、[TypeScript convergence](./r29-f-production-typescript-convergence.md)、[architecture test cleanup](./r29-g-architecture-source-test-cleanup.md)、[active documentation and naming](./r29-h-active-documentation-naming-cleanup.md)、[architecture convergence closure](./r29-i-architecture-convergence-closure.md)

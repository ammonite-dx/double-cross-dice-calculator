...
1. **R28-B2: Historical experiment test isolation / command cleanup**: historical experimentをproduction regression suiteから分離し、専用commandと実行対象を整理する。R28-B1のarchitecture enforcement cleanupは完了済みで、各review gateで停止する。

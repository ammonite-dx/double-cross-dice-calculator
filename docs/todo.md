...
6. 進行中: `codex/dynamic-distribution-ranges`で入力、中間計算、FFT、表示の範囲を一体的に決めるcore plannerを追加済み。warning/rejectのcalculator/UI接続と現行経路での検証を次に行う

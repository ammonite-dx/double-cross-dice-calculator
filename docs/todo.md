...
- 検証: `00b5b3f`で54 files/788 tests、`c26d511`で全56 files/798 tests、`check:node`、lint、`lint:markdown`、build、diff checkが成功した。独立レビューのP1を受け、期待値をDP bucketから切り離したDX tail-sum certificateへ修正し、`errorBound`を確率massへ加算しない既存契約へ統一した。
